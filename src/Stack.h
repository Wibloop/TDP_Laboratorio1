...
// Se comenta que representa la clase (Stack en este caso) a modo de abstraccion
// en lenguaje natural
...
private:
  ...
  // Metodo privado de apoyo para redimensionar el arreglo si se llena void
  // resize();
  void resize();
...
#endif /* Stack_h */ // Se utiliza para darle fin a los include Guards y avisar
                     // que hasta aqui es el archivo Stack_h